...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      items-center justify-center rounded-md border bg-transparent px-3 text-sm
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      opacity-0 transition-opacity focus:opacity-100 focus:outline-none focus:ring-2
